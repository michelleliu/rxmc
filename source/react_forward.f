      ...
      Integer Listreactants(4),Listproducts(4)
...
C           Choose Nreactants(Irxn) reactants from Box Ib
            ...
            If(ireactant.gt.1) Then
               Do jreactant=1,ireactant-1
     ...
     $           ,Ipart,Types(Ipart))
         ...
         Do iproduct=1,Nproducts(Irxn)
            ...
            Call Epart(Ib,Virdel(iproduct),Upotdel(iproduct)
